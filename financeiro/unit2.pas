...
procedure TfrmCadastroPadrao.btnCancelar1Click(Sender: TObject); //BOTAO CANCELAR
begin
  pnlPrincipal.PageIndex := pnlPrincipal.IndexOf(cardPesquisa);//FUNCAO PARA QUANDO CLIKAR NO BOTAO "CANCELAR" ABRIR A PAGINA "cardPesquisa"
end;
